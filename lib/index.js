...
var defaultMaxBufferSize = 512*1024;
...
function asyncFileToBuffer (filepath, options, callback) {
  ...
  fs.open(filepath, 'r', function (err, descriptor) {
    ...
    var MaxBufferSize = (options && options.maxBufferSize) || defaultMaxBufferSize;
...
function syncFileToBuffer (filepath, options) {
